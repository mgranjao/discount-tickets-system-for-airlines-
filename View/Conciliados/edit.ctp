...
<?php echo $this->Form->create('Conciliado'); ?>
	<fieldset>
		<legend><?php echo __('Edit Conciliado'); ?></legend>
	<?php
		echo $this->Form->input('CONC_ID');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Conciliado.CONC_ID')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Conciliado.CONC_ID'))); ?></li>
