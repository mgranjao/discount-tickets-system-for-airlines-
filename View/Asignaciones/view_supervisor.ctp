...
<h2><?php  echo __('Asignación'); ?></h2>
  ...
  <p>Información del descuento asignado: </p>

          <?php echo $this->Html->link(__('<- Regresar'), array('action' => 'historial_supervisor'), array('class' => 'regresar')); ?>
...
<br/>
<?php if ($reversado!=1){?>
<?php echo $this->Html->link(__('Reversar Asignación'), array('controller' => 'asignaciones', 'action' => 'reversar/'.$asignacione['Asignacione']['ASIG_ID']), array("class"=>"reversar"), null ,  __('¿Está seguro que desea reversar la asignación '.$asignacione['Asignacione']['ASIG_DET_CODIGO_AUTORIZACION'].'?')); ?>
<?php }else{?>
<?php echo $this->Html->link(__('Rescatar Asignación Reversada'), array('controller' => 'asignaciones', 'action' => 'rescatar/'.$asignacione['Asignacione']['ASIG_ID']), array("class"=>"rescatar") , null ,  __('¿Está seguro que desea rescatar la asignación '.$asignacione['Asignacione']['ASIG_DET_CODIGO_AUTORIZACION'].'?')); ?>
<?php }?>
</div>
