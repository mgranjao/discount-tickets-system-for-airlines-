...
<?php echo $this->Html->script('historial_supervisor'); ?>
...
<div class="asignaciones index">
    ...
    <div  class="fechas_historial">
        <ul>
            ...
            echo $this->Form->input('FECHA_INICIO', array(
                                    'label' => 'Fecha Inicio',
                                    'type' => 'text',
                                    'id' => 'datepickerIniHistorialSupervisor',
                                    'value' => $fecha_ini, 
                                    'class' => "required"
                ));
            ...
            <li>
                    <?php
                        echo $this->Form->input('FECHA_FIN', array(
                                                'label' => 'Fecha Fin',
                                                'type' => 'text',
                                                'id' => 'datepickerFinHistorialSupervisor',
                                                'value' => $fecha_fin, 
                                                'class' => "required"
                                                ));
    ?>
    ...
    <div class="menu_datatable">
            <ul>
                ...
                <?php echo $this->Html->link(__('Exportar'), array('controller' => 'asignaciones', 'action' => 'export_historial_supervisor_xls', "?" => array("ini" => $fecha_ini , "fin" => $fecha_fin )),array('class' => 'exportar_excel')); ?> 
...
<!--<div class="asignaciones index">
    ...
    <?php echo $this->Html->link(__('Exportar'), array('controller' => 'asignaciones', 'action' => 'export_historial_supervisor_xls')); ?> </li>                                 


    <input type="hidden" name="url" id="url" value="<?= Router::url('/', true) ?>">
-->
    <table id="data_table_asignaciones_supervisor" class="table table-bordered table-striped table_vam">
        <thead>
            <tr>
                <th>ID</th>
                <th>Residente</th>
...
<!--<div class="asignaciones index">
    ...
    <input type="hidden" name="url" id="url" value="<?= Router::url('/', true) ?>">
-->
    <table id="data_table_asignaciones_supervisor_2_pasos" class="table table-bordered table-striped table_vam">
        <thead>
            <tr>
                <th>ID</th>
                <th>Residente</th>
