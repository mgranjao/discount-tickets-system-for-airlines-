...
<?php echo $this->Form->create('Volado'); ?>
	<fieldset>
		<legend><?php echo __('Edit Volado'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Volado.VOL_ID')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Volado.VOL_ID'))); ?></li>
